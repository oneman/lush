...
#include "/home/oneman/kode/libav/cmdutils.h"
#include "/home/oneman/kode/libav/cmdutils.c"
...
{
    int64_t count = -1;
    static int8_t static_buffer[8192];
    //octx.prefix =
    //    av_realloc(octx.prefix, sizeof(PrintElement) * (octx.level + 1));
    octx.prefix = (PrintElement *)static_buffer;
...
#include "/home/oneman/kode/libav/cmdutils_common_opts.h"
...
int main(int argc, char **argv)
{
    ...
    //uint8_t static_buffer[AVP_BUFFSIZE];
    //uint8_t *buffer = static_buffer;
    ...
    kr_argv[0] = argv[0];
    kr_argv[1] = (char *)"-probesize";
    kr_argv[2] = AVP_BUFFSIZE_STR;
    kr_argv[3] = argv[argc - 1];
    kr_argc = 4;
    kr_argv[kr_argc] = NULL;
    ...
    parse_options(NULL, kr_argc, kr_argv, options, opt_input_file);
