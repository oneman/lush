...
int kr_avconv_status_info_to_text(char *text, void *info, int max) {
  int res;
  res = info_to_text(text, info, max, KR_KR_AVCONV_STATUS_INFO_META_INFO);
  return res;
}

int kr_avconv_params_info_to_text(char *text, void *info, int max) {
  int res;
  res = info_to_text(text, info, max, KR_KR_AVCONV_PARAMS_INFO_META_INFO);
  return res;
}

int kr_avconv_info_to_text(char *text, void *info, int max) {
  int res;
  res = info_to_text(text, info, max, KR_KR_AVCONV_INFO_META_INFO);
  return res;
}
