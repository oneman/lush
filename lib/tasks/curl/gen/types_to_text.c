...
int kr_curl_status_info_to_text(char *text, void *info, int max) {
  int res;
  res = info_to_text(text, info, max, KR_KR_CURL_STATUS_INFO_META_INFO);
  return res;
}

int kr_curl_params_info_to_text(char *text, void *info, int max) {
  int res;
  res = info_to_text(text, info, max, KR_KR_CURL_PARAMS_INFO_META_INFO);
  return res;
}

int kr_curl_info_to_text(char *text, void *info, int max) {
  int res;
  res = info_to_text(text, info, max, KR_KR_CURL_INFO_META_INFO);
  return res;
}
