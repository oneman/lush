...
int kr_transmission_cli_status_info_pack_json(char *json, void *info, int max) {
  int res;
  res = info_pack_json(json, info, max, KR_KR_TRANSMISSION_CLI_STATUS_INFO_META_INFO);
  return res;
}

int kr_transmission_cli_params_info_pack_json(char *json, void *info, int max) {
  int res;
  res = info_pack_json(json, info, max, KR_KR_TRANSMISSION_CLI_PARAMS_INFO_META_INFO);
  return res;
}

int kr_transmission_cli_info_pack_json(char *json, void *info, int max) {
  int res;
  res = info_pack_json(json, info, max, KR_KR_TRANSMISSION_CLI_INFO_META_INFO);
  return res;
}
