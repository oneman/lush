/* ries.c
    ...
    Copyright (C) 2000-2023 Robert P. Munafo
    This is the 2023 Aug 01 version of "ries.c"
...
#define RIES_VERSION "2023 Aug 01"
...
{
  printf(
    "ries version of %s, Copyright (C) 2000-2023 Robert P. Munafo\n",
    RIES_VERSION);
